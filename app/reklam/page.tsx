      ...
      <div className="py-10">
        <div className="container mx-auto px-4">
          ...
          <div className="prose max-w-none">
            <p className="mb-4">
              TV42, Türkiye&rsquo;nin önde gelen bölgesel televizyon kanallarından biridir. Geniş bir izleyici kitlesine sahip olan kanalımızda reklam vermek markanız için önemli bir tanıtım fırsatıdır.
            </p>
            ...
            <h2 className="text-xl font-bold mt-8 mb-4">Neden TV42&rsquo;de Reklam Vermelisiniz?</h2>
            ...
            <p className="mb-2">
              <strong>E-mail:</strong> reklam@tv42.com.tr
            </p>
