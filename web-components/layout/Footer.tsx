      ...
      <div className="container mx-auto px-4 max-w-full">
        ...
        <div className="text-center mb-8 px-2">
          <p className="text-sm leading-relaxed max-w-3xl mx-auto">
            TV42, 10 Haziran 1992'de kuruldu. Türkiye'nin ilk bölgesel yayın yapan kanalı olarak tarihe geçen TV42, 2004 yılından buyana uydudan tüm dünyaya yayın yapmaktadır.
            Kablolu Yayın, Tivibu, DSmart, Turkcell TV, IPTV, IPETTV, Teledünya ve Karasal yayını bulunan TV42, Türkiye'nin önde gelen kanallarından biridir.
          </p>
        </div>
        ...
        <div className="border-t border-gray-800 py-4 text-center text-xs text-gray-400">
          <p>
            © {new Date().getFullYear()} TV42. Tüm hakları saklıdır.
          </p>
          <p className="mt-1">
            <span>Eras Medya Çözümleri tarafından geliştirilmiştir.</span>
          </p>
        </div>
      </div>
    </footer>
